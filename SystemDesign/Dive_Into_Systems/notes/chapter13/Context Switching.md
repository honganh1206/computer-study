...
Scenario: A process is running on the CPU. When the OS starts running, it executes context switching code that can saves/restores the full execution state of the process. 
