...
Requests to the OS can also come from user applications. When an application writes to a file, it makes a [[System call]] to the OS to perform write on its behalf. This is referred to as **traps**
